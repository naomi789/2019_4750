...
(gloss_ID INT AUTO_INCREMENT NOT NULL, gloss_def NVARCHAR(300), 
CONSTRAINT PK_gloss PRIMARY KEY (gloss_ID) );

CREATE TABLE IF NOT EXISTS gloss_word
(ent_seq INT NOT NULL, gloss_ID INT NOT NULL,
CONSTRAINT PK_gloss_word PRIMARY KEY (ent_seq, gloss_ID) );

CREATE TABLE IF NOT EXISTS list
(list_ID INT AUTO_INCREMENT NOT NULL, list_name NVARCHAR(200), list_description NVARCHAR(2000),
CONSTRAINT PK_list PRIMARY KEY (list_ID) );

CREATE TABLE IF NOT EXISTS list_word
(ent_seq INT NOT NULL, list_ID INT NOT NULL,
