...
output = 'jmdict_inserts_part_1.sql'
# output = '../mini_practice_commands/mini.sql'
# bridge_output = '../mini_practice_commands/mini_bridges.sql'
bridge_output = 'jmdict_inserts_part_2.sql'
